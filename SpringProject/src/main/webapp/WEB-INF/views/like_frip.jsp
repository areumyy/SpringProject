							...
							<c:forEach items="${classList }" var="dto" varStatus="status">
								<div class="list_inner">
									<a href="#">
										...
										<c:if test="${optionCont[status.index].getOption_editPrice() eq null}">
											<div class="class_price"> 
												<fmt:formatNumber value="${optionCont[status.index].getOption_price() }" />원 
											</div>
										</c:if>
										<c:if test="${optionCont[status.index].getOption_editPrice() ne null}">
											<div class="class_price"> 
												<span><fmt:formatNumber value="${optionCont[status.index].getOption_price() }" /> 원</span>
												<span class="class_editPrice"><fmt:formatNumber value="${optionCont[status.index].getOption_editPrice() }" /></span>
											</div>
										</c:if>
