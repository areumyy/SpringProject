									...
									<div class="pgCard_wrapper">
										...
										<div class="pgCard_product_wrapper">
											...
											<div class="additionalInfo_wrapper">
												<img class="additionalInfo_icon" src="<%=request.getContextPath() %>/resources/image/mypage/cal.svg">
										...
										<div class="pgCard_footer_wrapper">
											<div class="pgCard_footer_info">
												<div><strong>[예약확정]</strong></div>
											<span class="mypage_footer_txt">1인 이용권 ★오전 클래스(10:30) 특별 할인★</span>
											</div>
										</div>
									</div>
